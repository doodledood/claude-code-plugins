...
Requires Python 3.10+ and [uv](https://docs.astral.sh/uv/). Supports any provider via [LiteLLM](https://docs.litellm.ai/docs/providers).
...
- `/babysit-pr` - Loop pr-merge-prep until PR is merge-ready, then ask before merging
