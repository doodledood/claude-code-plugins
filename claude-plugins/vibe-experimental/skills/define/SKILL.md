...
**Verification method selection**: Bash for deterministic checks (e.g., lint, test, typecheck) | Subagent for logic/reasoning/judgment | Manual only when automation is impossible.
