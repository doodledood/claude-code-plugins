#!/usr/bin/env python3
"""
SessionStart hook that reminds Claude to prefer codebase-analyst over built-in Explore agent.
"""
import sys
...
def main() -> None:
    ...
    print(
        ...
        "planning implementation, debugging, or onboarding - prefer using the `codebase-analyst` agent "
        "(subagent_type: vibe-workflow:codebase-analyst) instead of the built-in Explore agent. "
