...
|------|-----|--------|------|
| 2026-04-30 | [The sync tool deletes only what it previously wrote](20260430-tracked-set-deletion-protects-coexisting-plugins.md) | Superseded by [20260905-use-installed-manifest-dev-plugins](20260905-use-installed-manifest-dev-plugins.md) | Plugin sync |
...
| 2026-08-07 | [The sync tool decides skill layout once per repository, not per skill](20260807-layout-verdict-is-per-repo-not-per-skill.md) | Superseded by [20260905-use-installed-manifest-dev-plugins](20260905-use-installed-manifest-dev-plugins.md) | Plugin sync |
...
| 2026-09-04 | [code-coverage-reviewer is retired in favour of the synced test-quality dimension](20260904-code-coverage-reviewer-retired.md) | Accepted | Plugin structure |
