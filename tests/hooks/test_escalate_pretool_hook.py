"""
Tests for vibe-experimental pretool_escalate_hook.
...
class TestEscalateHookBlocking:
    ...
    def test_blocks_without_verify(
        ...
        hook_input = {
            ...
            "tool_name": "Skill",
            "tool_input": {"skill": "vibe-experimental:escalate", "args": "AC-5 blocking"},
        }
...
class TestEscalateHookAllowing:
    ...
    def test_ignores_non_escalate_skills(
        ...
        hook_input = {
            "transcript_path": transcript_path,
            "tool_name": "Skill",
            "tool_input": {"skill": "vibe-experimental:verify"},
        }
